...
export default function Home() {
  ...
  return (
    <main className="mx-auto flex min-h-[80vh] w-full max-w-3xl flex-col justify-center gap-9 px-6 py-16 text-foreground">
      ...
      <form
        ...
        className="w-full space-y-5 rounded-3xl border border-white/12 bg-[#0b0f14] px-7 py-7 shadow-[0_1px_0_rgba(255,255,255,0.05)]"
      >
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-white/12 bg-[#10141c] px-4 py-3 text-sm text-white shadow-inner outline-none transition focus:border-white/35 focus:ring-0"
            autoComplete="off"
          />
        </div>
        <div className="space-y-1.5">
        ...
        <Button
          type="submit"
          disabled={isDisabled}
          className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-white text-black transition hover:bg-white/90 disabled:cursor-not-allowed disabled:opacity-60"
        >
          Check What&apos;s New
